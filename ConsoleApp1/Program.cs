...
class Person
{
    ...
    {
        return "Name: " + name+ " Surname: "+ surname + " date_of_birth: " + date_of_birth.ToString();
    }
...
class Program
{
    ...
    {
        var Person1 = new Person("Kirill", "Karpekin", DateTime.Now);
        var Person2 = new Person("Low", "Tab", DateTime.Now);

        var date1 = DateTime.Now;
        var date2 = new DateTime(2004, 10, 04);
        var date3 = new DateTime(2004, 7, 22);
        ...
        student.Exam = new Exam[] { new Exam("math", 5, date3) };
        student.Group = 10;

        student.AddExams(new Exam("tehnologe", 5, date1), new Exam("dota 2", 2, date2));

        student2.AddExams(new Exam("biologe", 5, date1), new Exam("phisics", 5, date2));
